...
async function InternationalizeCommandDescriptions() {
  console.log(
    "[Background] InternationalizeCommandDescriptions() :: Can Reset Commands?",
  ...
  if (typeof browser.commands.reset === "function") {
    ...
    for (const command of commands) {
      console.log(
        `[Background] InternationalizeCommandDescriptions() :: Processing "${command.name}" command`,
        command
      );
      ...
      console.log(
        `[Background] InternationalizeCommandDescriptions() :: Default "${command.name}" description`,
        description
      );
      ...
      if (msg && msg[1]) {
        ...
        console.log(
          `[Background] InternationalizeCommandDescriptions() :: Internationalized "${command.name}" command description`,
          description
        );
      }
